...
export interface TestPredictionInterface extends Interface {
...
export interface TestPrediction extends BaseContract {
  connect(runner?: ContractRunner | null): TestPrediction;
  waitForDeployment(): Promise<this>;

  interface: TestPredictionInterface;
